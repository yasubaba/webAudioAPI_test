...
exports.RemoteMediaStreamBase = void 0;
const base_1 = require("../base");
const base_2 = require("./base");
class RemoteMediaStreamBase extends base_2.RemoteStreamBase {
    ...
    attach(element) {
        ...
        (0, base_1.attachElement)(element, this.track);
    }
    /**
    ...
    detach() {
        if (this._element) {
            (0, base_1.detachElement)(this._element, this.track);
            this._element = undefined;
        }
    }
}
exports.RemoteMediaStreamBase = RemoteMediaStreamBase;
