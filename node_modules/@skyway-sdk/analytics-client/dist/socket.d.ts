...
import { OpenServerEventPayload } from './payloadTypes';
...
export declare class Socket {
    ...
    constructor({ channelId, channelName, memberId, memberName, sessionEndpoint, token, logger, sdkVersion, }: SocketParams);
